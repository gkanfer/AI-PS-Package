...
#                      offset=0.01, size_smooth=19, opensize=7, largeobj=100000, minmaxnorm=TRUE)
#   table = extractFeatures(img, cseg$seg)
#   expect_output(capture_output(
#     pickCells(nseg$seg, xy, table$table, int, nseg$features, font_size=0.7, label_class="Postive", display_select=TRUE))) 
# })